% =====================================================================
% IEEE GRSL - REVIEW VERSION (single column, double space)
% Identical content to robles_leyton_grsl_2026.tex
% =====================================================================
...
\begin{figure*}[t]
\centering
\includegraphics[width=0.9\textwidth]{roble1}
...
code are available at \url{https://github.com/JMR-Independent/sentinel-refugee-detection}
(archived at doi:~10.5281/zenodo.18653397).
